...
<body class="bg-gray-100 font-sans text-gray-800">
    ...
    <div class="max-w-xl mx-auto mt-10 p-8 bg-white rounded-2xl shadow-lg">
        <h1 class="text-2xl font-bold mb-6 text-blue-700 text-center">➕ Tambah Pelanggan Baru</h1>
        ...
        <form action="{{ url('/pelanggan') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <textarea name="alamat" id="alamat" rows="3"
                          class="w-full mt-1 px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('alamat') }}</textarea>
            </div>
